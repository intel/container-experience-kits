...
{{ .Values.serviceAccount.name | default (include "telemetry-aware-scheduling.fullname" .) }}
{{- end -}}

{{/*
Service name to use
*/}}
{{- define "telemetry-aware-scheduling.serviceName" -}}
{{ .Values.service.name | default (include "telemetry-aware-scheduling.fullname" .) }}
{{- end -}}
